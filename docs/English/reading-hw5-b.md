...
1. TPO 16 Planets in Our Solar System (正确率 69.03%) 
        ...
        Q: Paragraph 4 supports each of the following statements about **Saturn** EXCEPT: 
...
2. TPO 20 Westward Migration (正确率 68.56%) 
        ...
        Q: Paragraph 5 mentions that ==the Erie Canal led to a reduction in== all of the following EXCEPT 
...
3. TPO 21 The Origins of Agriculture (正确率 68.53%) 
        ...
        Q: According to paragraph 1, all of the following are **advantages** of ==hunting and gathering over agriculture== EXCEPT: 
...
4. TPO 1 Groundwater (正确率 68.31%) 
        ...
        Q: All of the following are mentioned in paragraph 3 as ==places that sediment-laden rivers can deposit their sediments== EXCEPT 
...
5. :question:TPO 25 The Decline of Venetian Shipping (正确率 67.24%) 
        ...
        Q: All of the following are mentioned in paragraph 3 and 4 as contributing to ==the problems of the Venetian shipbuilding industry at the end of the sixteenth century== EXCEPT 
...
6. TPO 20 Westward Migration (正确率 66.99%)    
        ...
        Q: According to paragraph 2, all of the following are **reasons** why ==Americans migrated westward== EXCEPT
...
7. :question:TPO 20 Early Settlements in the Southwest Asia (正确率 66.92%) 
        ...
        Q: According to paragraph 5, ==after 7000 B.C. the settlement of Abu Hureyra differed from earlier settlements at that location== in all of the following EXCEPT
...
8. TPO 33 Railroads and Commercial Agriculture in Nineteenth-Century United States (正确率 66.21%)   
        ...
        Q: According to paragraph 8, ==prairie farmers changed the landscape by doing== all of the following EXCEPT: 
...
9. :question:TPO 6 Infantile Amnesia (正确率 64.44%) 
        ...
        Q: All of the following theories about ==the inability to recall early experiences are rejected== in paragraph 2 EXCEPT: 
...
10. TPO 4 Petroleum Resources (正确率 64.4%) 
        ...
        Q: According to paragraph 5, ==the decision to drill for oil depends on all of the following factors== EXCEPT
...
11. TPO 24 Breathing During Sleep (正确率 58.99%) 
        ...
        Q: All of the following are mentioned in paragraph 4 as ==being characteristic of breathing during sleep== EXCEPT 
...
12. TPO 10 Seventeenth-Century European Economic Growth (正确率 56.77%) 
        ...
        Q: According to paragraph 8, each of the following was ==a source of funds used to finance economic expansion== EXCEPT 
...
13. TPO 30 The Invention of the Mechanical Clock (正确率 56.77%) 
        ...
        Q: According to paragraph 2, all of the following are examples of ==the importance of timekeeping to medieval European society== EXCEPT: 
...
14. TPO 19 The Roman Army's Impact on Britain (正确率 55.49%) 
        ...
        Q: According to paragraph 4, all of the following ==changes could be seen in the frontier garrisons by the later Roman period== EXCEPT: 
...
15. TPO 21 Autobiographical Memory (正确率 54.58%) 
        ...
        Q: All of the following are mentioned in paragraph 4 as ways in which ==parents help their children understand the structure of narratives== EXCEPT 
...
16. TPO 34 Protection of Plants by Insects (正确率 53%) 
        ...
        Q: According to paragraph 5, ==ants defend morning glory plants from seed beetles== in each of the following ways EXCEPT 
...
17. :question:TPO 8 Running Water on Mars (正确率 50.73%) 
        ...
        Q: All of the following questions about ==geological features on Mars== are answered in paragraph 3 EXCEPT: 
...
18. :question:TPO 8 Running Water on Mars (正确率 50.09%) 
        ...
        Q: According to paragraph 2, all of the following are true of ==the outflow channels on Mars== EXCEPT: 
...
19. TPO 12 Which Hand Did They Use? (正确率 43.75%) 
        ...
        Q: All of the following are mentioned in paragraphs 1 and 2 as evidence of ==right-handedness in art and artists== EXCEPT 
...
20. TPO 14 Pastoralism in Ancient Inner Eurasia (正确率 39.37%) 
        ...
        Q: According to paragraph 4, all of the following are true of ==social inequality in pastoralist societies== EXCEPT:
