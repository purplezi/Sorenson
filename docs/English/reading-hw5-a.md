...
2. TPO 8 Running Water on Mars (正确率 68.41%)
   ...
   Q: According to paragraph 3, ==images of Mars’ surface have been interpreted as support== **for** the idea that 
...
3. TPO 28 Buck Rubs and Buck Scrapes (正确率 68.16%) 
   ...
   Q: According to the passage, **in what way** do ==buck scrapes differ from buck rubs==?
...
4. TPO 21 The Origins of Agriculture (正确率 68.05%) 
   ...
   Q: According to paragraph 3, ==the abundance of resources fluctuated sharply after the end of the glacial period== **because**
...
5. :question:TPO 23 Seventeenth-Century Dutch Agriculture (正确率 68%) 
   ...
   Q: Select the TWO answer choices that, according to paragraph 4, indicate **two methods** ==people used to increase the productivity of their land==. To receive credit you must select TWO answers 
...
6. TPO 15 Mass Extinction (正确率 67.94%) 
   ...
   Q: According to paragraph 6, **what** made ==iridium a useful test of the Alvarez hypothesis==?
...
7. TPO 10 Seventeenth-Century European Economic Growth (正确率 67.89%) 
   ...
   Q: Paragraph 4 supports the idea that ==increased agricultural production was important for the expansion of industry primarily== **because** it. 
...
8. TPO 11 Ancient Egyptian Sculpture (正确率 67.66%) 
   ...
   Q: According to paragraph 3, which of the following statements about ==wooden statues== is **true**? 
...
9. TPO 28 Early Saharan Pastoralists (正确率 67.39%) 
   ...
   Q: Paragraph 2 **supports** which of the following ideas about ==wild oxen in the Sahara region after the drought took hold==? 
...
10. TPO 19 Succession, Climax, and Ecosystems (正确率 67.37%) 
    ...
    Q: According to paragraph 2, which of the following **is** ==a criticism of Clements “view of succession”==? 
...
11. TPO 20 Fossil Preservation (正确率 67.21%) 
    ...
    Q: Which of the following **best explains** ==the process of permineralization== mentioned in paragraph 3？ 
...
12. TPO 6 Infantile Amnesia (正确率 67.19%) 
    ...
    Q: According to paragraph 4, **what role** may ==storytelling play in forming childhood memories==? 
...
13. TPO 22 Spartina (正确率 66.95%) 
    ...
    Q: According to paragraph 4, ==in its natural habitats, Spartina helps estuaries== **by** 
...
14. .TPO 27 The Formation of Volcanic Islands (正确率 66.4%) 
    ...
    Q: According to paragraph 5, **why** are ==geologists unable to trace back the entire geologic of continents from hot-spot trails==? 
...
15. :question:TPO 4 Petroleum Resources (正确率 66.39%) 
    ...
    Q: **Which** of the following **strategies** for ==oil exploration== is describe in paragraph 4?
...
16. TPO 11 Begging by Nestlings (正确率66.36%) 
    ...
    Q: ==The experiment described in paragraph 2 supports== **which** of the following **conclusions**? 

    A.Predators are unable to distinguish between the begging cheeps of ground-nesting and those of treenesting warblers except by the differing frequencies of the calls. 
...
17. TPO 13 Methods of Studying Infant Perception (正确率66.25%) 
    ...
    Q: According to paragraph 4, which of the following **leads to the conclusion** that ==infants are able to differentiate between stimuli in a habituation dishabituation study==?
...
18. TPO 23 Seventeenth-Century Dutch Agriculture (正确率 66.12%) 
    ...
    Q: According to paragraph 5, which of the following was an important reason **why** ==land- reclamation projects in the first half of the seventeenth century proceeded rapidly==? 
...
19. TPO 16 Trade and the Ancient Middle East (正确率 65.54%) 
    ...
    Q: According to paragraph 2, **how** did ==Middle Eastern shop owners treat their workers==?
...
20. TPO 29 The History of Waterpower (正确率 65.51%) 
    ...
    Q: According to paragraph 2, what was **true** of ==the waterpower mills built throughout the Roman Empire==? 
...
21. TPO 3 Architecture (正确率65.36%) 
    ...
    Q: Which of the following **correctly characterizes** ==the relationship between the human body and architecture== that is described in paragraph5? 
...
22. .TPO 29 Competition (正确率 65.34%) 
    ...
    Q: Paragraph 3 supports the idea that ==Gause's experiments were important== **because** they
...
23. TPO 11 Orientation and Navigation (正确率 65.24%) 
    ...
    Q: According to paragraph 3, **when** do ==caged starlings become restless==? 
...
24. TPO 18Lightning (正确率 64.14%) 
    ...
    Q: According to paragraph 2, **why** are ==positively charged ice pellets produced in the lower part of the cloud==? 
...
26. :question:TPO 1 The Origins of Theater (正确率 64.07%) 
    ...
    Q: According to paragraph 2, what may **cause** ==societies to abandon certain rites==?
...
27. TPO 2 The Origins of Cetaceans (正确率 63.93%) 
    ...
    Q: In paragraph 1, **what** does the author say about ==the presence of a blowhole in cetaceans==? 
...
28. .TPO 31 Savanna Formation (正确率 63.82%) 
    ...
    Q: Paragraph 5 **supports** which of the following statements regarding ==the importance of fires in maintaining savannas==? 
...
29. TPO19 Discovering the Ice Ages(正确率 63.75%) 
    ...
    Q: According to the passage, **when** did ==scientists begin to realize that more than one ice age had occurred==? 
...
30. TPO 10 Seventeenth-Century European Economic Growth (正确率 63.64%) 
    ...
    Q: According to paragraph 7, until the eighteenth century, it was the ==principal function== of which of the following to ==provide funds for the state==? 
...
31. TPO 6 William Smith (正确率 63.61%) 
    ...
    Q: Select the TWO answer choices that are **true** statements based upon ==the discussion of the principle of faunal succession== in paragraph 5. To receive credit, you must select TWO answers. 
